...
export VERILOG_FILES = $(TARGET_FILE) \
							...
							$(PLATFORM_DESIGN_DIR)/sram/verilog/liteeth_1rw1r_64w1024d_sram.v
...
export ADDITIONAL_LEFS = \
  ...
  $(PLATFORM_DESIGN_DIR)/sram/lef/liteeth_1rw1r_64w1024d_sram.lef

export ADDITIONAL_LIBS = \
  $(PLATFORM_DESIGN_DIR)/sram/lib/liteeth_1rw1r_64w64d_sram.lib \
  $(PLATFORM_DESIGN_DIR)/sram/lib/liteeth_1rw1r_64w1024d_sram.lib

# total 7 violations
# export CORE_UTILIZATION = 40
# export PLACE_DENSITY = 0.37
# export MACRO_PLACE_HALO = 100 50
