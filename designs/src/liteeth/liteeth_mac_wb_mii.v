...
`endif
    ...
    .clk0(sys_clk),
    .ce_rw1(1'b1),                                        // Always enabled
    .we_in_rw1(wishbone_interface_writer_memory0_we),       // Active low write enable
    .addr_rw1(wishbone_interface_writer_memory0_adr),
    .wd_in_rw1(wishbone_interface_writer_memory0_dat_w),
    .rd_out_rw1(wishbone_interface_writer_memory0_dat_r),
    
    // Port 1: R (Read-only)
    .clk1(sys_clk),
    .ce_r1(1'b1),                                        // Always enabled
    .addr_r1(wishbone_interface_sram0_adr),
    .rd_out_r1(wishbone_interface_sram0_dat_r)
);
...
`endif
    ...
    .clk0(sys_clk),
    .ce_rw1(1'b1),                                        // Always enabled
    .we_in_rw1(wishbone_interface_writer_memory1_we),       // Active low write enable
    .addr_rw1(wishbone_interface_writer_memory1_adr),
    .wd_in_rw1(wishbone_interface_writer_memory1_dat_w),
    .rd_out_rw1(wishbone_interface_writer_memory1_dat_r),
    
    // Port 1: R (Read-only)
    .clk1(sys_clk),
    .ce_r1(1'b1),                                        // Always enabled
    .addr_r1(wishbone_interface_sram1_adr),
    .rd_out_r1(wishbone_interface_sram1_dat_r)
);
...
`endif
    .clk0(sys_clk),
    .ce_rw1(1'b1),
    .we_in_rw1(~|wishbone_interface_sram2_we),
    .w_mask_rw1(wishbone_interface_sram2_we),
    .addr_rw1(wishbone_interface_sram2_adr),
    .wd_in_rw1(wishbone_interface_sram2_dat_w),
    .rd_out_rw1(wishbone_interface_sram2_dat_r),
    .clk1(sys_clk),
    .ce_r1(wishbone_interface_reader_memory0_re),
    .addr_r1(wishbone_interface_reader_memory0_adr),
    .rd_out_r1(wishbone_interface_reader_memory0_dat_r)
);
...
`endif
    .clk0(sys_clk),
    .ce_rw1(1'b1),
    .we_in_rw1(~|wishbone_interface_sram3_we),
    .w_mask_rw1(wishbone_interface_sram3_we),
    .addr_rw1(wishbone_interface_sram3_adr),
    .wd_in_rw1(wishbone_interface_sram3_dat_w),
    .rd_out_rw1(wishbone_interface_sram3_dat_r),
    .clk1(sys_clk),
    .ce_r1(wishbone_interface_reader_memory1_re),
    .addr_r1(wishbone_interface_reader_memory1_adr),
    .rd_out_r1(wishbone_interface_reader_memory1_dat_r)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-08-19 04:17:41.
//------------------------------------------------------------------------------
